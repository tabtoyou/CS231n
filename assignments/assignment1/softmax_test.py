...
for lr in learning_rates:
    for reg in regularization_strengths:
        sftm = Softmax()
        loss_hist = sftm.train(X_train, y_train, learning_rate=lr, reg=reg, num_iters=1500, verbose=True)
...
y_test_pred = best_sftm.predict(X_test)
...
w = best_sftm.W[:-1,:] # strip out the bias
